    ...
    <div class="article_content">
      <div class="article-text">
        ...
        <div class="metabox1"> 
          ...
          <span class="entry-comments"><i class="fas fa-comments"></i><?php comments_number( __('0 Comments','inside-tours'), __('0 Comments','inside-tours'), __('% Comments','inside-tours') ); ?></span>
        </div>
